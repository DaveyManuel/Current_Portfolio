...
function WeatherDashboard(){
    return(
        ...
        <h1 className="text-center text-info">Weather Dashboard</h1>
        <div className="row bg-dark bg-gradient">
          ...
          <div className="col-9 text-white mt-3">
            <p className="fs-5">In this project, I have built a simple weather application that takes in user input within a form field.
